...
const elementary = {
    _appImageLauncher: {
        instructions: "Go <a href=\"https://github.com/TheAssassin/AppImageLauncher/releases\">https://github.com/TheAssassin/AppImageLauncher/releases</a> and download the appropriate .deb file. Then execute the below in terminal.",
        code: "sudo dpkg -i appimagelauncher_*.deb"
    },
    _atom: {
        instructions: "Execute the below in terminal (<code>cmd+t</code> or <code>ctrl+alt+t</code> on most distros).",
